...
// o nome da classe que consta é identificado automaticamente pelo spl_autoload_register() quando for estanciado apartir do respectivo local que foi declarado.
spl_autoload_register(function($class_name){
	...
	if ($class_name === "Sql") {
		...
		$texto = "Passo 2.1 no config.php - Faz o autoload da classe ".$class_name.", momento em que é ativada a function __construct nesta mesma classe : " . $class_name . "<br>". "<br>";
		$msg->echoMsg($texto);
	} else {
		$msg = new Passei_por_aqui();
		$texto = "Passo 2.1 no config.php - Faz o autoload da classe: " . $class_name . "<br>". "<br>";
		$msg->echoMsg($texto);
	}
