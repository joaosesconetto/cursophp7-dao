...
spl_autoload_register(function($class_name){
	...
	echo "Passo 2.1 no config.php - Faz o autoload da classe: " . $class_name ."<br>";
	// deve ser concatenado o sufixo .php ao nome da classe para que esta classe ou arquivo seja carregado.
	$filename = "class".DIRECTORY_SEPARATOR.$class_name.".php";
	
	// abaixo é meu teste, na passagem do programa por aqui
	echo "Passo 2.2 no config.php - concatena a classe Sql com .php, e verifica se a o arq. de classe existe na pasta atual. Se existir abre o arquivo e começa a executa-lo (requere_once) ==> " . $filename ."<br>"."<br>";	
